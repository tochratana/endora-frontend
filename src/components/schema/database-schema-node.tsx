...
import {
  ...
  BaseNodeContent,
  BaseNodeHeader,
} from "@/components/schema/base-node";
...
export const DatabaseSchemaNodeHeader = ({
  ...
  return (
    <BaseNodeHeader className="rounded-tl-md rounded-tr-md bg-gray-200 p-2 text-center text-sm text-gray-700 dark:bg-slate-950 dark:text-gray-100">
      <h2>{children}</h2>
    </BaseNodeHeader>
  );
};
