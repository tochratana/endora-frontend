        ...
        >
          {teamMembers
            ...
            .map(tm => (
              <div
                key={tm.id}
                className="col-span-2 flex flex-col items-center h-full bg-no-repeat bg-contain"
                style={{
                  backgroundImage: `url(${tm.background})`,
                  backgroundPosition:
                    tm.name === "Korm TaingAn" ? "-10px top" : "center top",
                }}
              >
                ...
                <div className="flex flex-col mt-4">
                  <h1 className="font-semibold md:text-lg text-[var(--color-primary)]">
                    {tm.name}
                  </h1>
