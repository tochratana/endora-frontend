...
export default function HeroSection() {
  return (
    <section className="max-w-6xl m-auto flex flex-col item-center text-center justify-center py-15 gap-5">
      ...
      <p className="md:w-[60%] w-[70%] m-auto md:text-md text-sm font-bold text-black dark:text-white">
      ...
      <button>
        <Link
          href="/"
          className="md:px-4 px-2 py-2 bg-(--color-secondary) text-white rounded text-sm font-semibold"
        >
          Start your project
        </Link>
      </button>
