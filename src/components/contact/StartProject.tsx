...
export default function StartProject() {
  return (
    <section className="w-full m-auto max-w-6xl py-10 grid grid-cols-8 px-2 md:gap-2 gap-4 min-h-[400px] items-center">
      <div className="md:col-span-4 col-span-8">
        ...
        <div className="grid grid-cols-5">
          <Link href="/signup"
            className="md:col-span-2 col-span-3 inline-flex items-center justify-center py-2 px-4 rounded font-semibold border-[1px] border-[var(--color-secondary)]"> Sign Up</Link>
        </div>
      </div>
